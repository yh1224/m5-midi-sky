...
static const std::map<int, MappingEntry> mappings[] = {
    // Mapping 1
    {
        ...
        {5, {ACTION_BUTTON, D_BUTTON_A}}, // A
        {7, {ACTION_DPAD, DIRECTION_LEFT}}, // D-Pad ←
        {9, {ACTION_BUTTON, D_BUTTON_X}}, // X
        {11, {ACTION_DPAD, DIRECTION_UP}}, // D-Pad ↑
        {12, {ACTION_BUTTON, D_BUTTON_Y}}, // Y
        {14, {ACTION_DPAD, DIRECTION_RIGHT}}, // D-Pad →
        {16, {ACTION_BUTTON, D_BUTTON_B}}, // B
        {17, {ACTION_BUTTON, D_BUTTON_L}}, // L
        {19, {ACTION_BUTTON, D_BUTTON_R}}, // R
    ...
    // Mapping 2
    {
        ...
        {17, {ACTION_BUTTON, D_BUTTON_A}}, // A
        {19, {ACTION_BUTTON, D_BUTTON_B}}, // B
        {21, {ACTION_BUTTON, D_BUTTON_Y}}, // Y
        {23, {ACTION_BUTTON, D_BUTTON_R}}, // R
