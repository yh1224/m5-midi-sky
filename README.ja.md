...
- **マッピング切り替え**: M5StackのButton Bで切り替え可能な2つの異なるボタン/制御マッピング
- **トランスポーズアシスト**: Button A/Cを使って音符の範囲を半音階単位でずらし、異なるキーの楽譜を直接演奏可能
...
- **Button A**: 移調ダウン（低いピッチ）
- **Button B**: マッピングモード切り替え（2つの異なる制御スキーム）
- **Button C**: 移調アップ（高いピッチ）
...
- **移調**: Button A/Cを使用して、全体の範囲を半音階単位で上下にシフト
